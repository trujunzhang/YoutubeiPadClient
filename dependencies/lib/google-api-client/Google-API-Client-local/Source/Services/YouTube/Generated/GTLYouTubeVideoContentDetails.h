...
// The value of captions indicates whether the detailVideo has captions or not.
@property (copy) NSString *caption;

// Specifies the ratings that the detailVideo received under various rating schemes.
...
// a detailVideo is (or is not) viewable.
@property (retain) GTLYouTubeAccessPolicy *countryRestriction;

// The value of definition indicates whether the detailVideo is available in high
// definition or only in standard definition.
@property (copy) NSString *definition;

// The value of dimension indicates whether the detailVideo is available in 3D or in
// 2D.
@property (copy) NSString *dimension;

// The length of the detailVideo. The tag value is an ISO 8601 duration in the format
...
// integers that specify the number of minutes (or seconds) of the detailVideo. For
// example, a value of PT15M51S indicates that the detailVideo is 15 minutes and 51
// seconds long.
@property (copy) NSString *duration;

// The value of is_license_content indicates whether the detailVideo is licensed
// content.
...
// detailVideo is (or is not) viewable. The object will contain either the
